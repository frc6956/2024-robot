...
public class Swerve extends SubsystemBase {
    ...
    public void resetPose(Pose2d pose) {
       swerveOdometry.resetPosition(new Rotation2d(gyro.getYaw().getValueAsDouble(),gyro.getYaw().getValueAsDouble()), getModulePositions(), pose);
    }
    ...
    public void rotateToDegree(double target){
        ...
        double rotate = rotController.calculate(gyro.getYaw().getValueAsDouble(), target);
    ...
    public void autoBalance(){
        ...
        while(timer.get() < 8){
            ...
            target = balanceController.calculate(gyro.getPitch().getValueAsDouble(), Constants.gyroOffset);
