...
//	private final AHRS m_gyro = new AHRS(); // usign SPI by default, which is what we want.
	...
	public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
		...
		var swerveModuleStates = DrivetrainConstants.DRIVE_KINEMATICS.toSwerveModuleStates(
			fieldRelative
				? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered, Rotation2d.fromDegrees(GYRO_ORIENTATION * gyro.getAngle()))
	...
	public double getHeading() {
		return Rotation2d.fromDegrees(-1 * GYRO_ORIENTATION * gyro.getAngle()).getDegrees();
	}
