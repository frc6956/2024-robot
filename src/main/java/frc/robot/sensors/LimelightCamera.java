...
public class LimelightCamera implements /*PIDSource,*/ ICamera {
	...
	private static final double TARGET_HEIGHT_INCHES = 2.0; //set proper value PROPER VALUE IS 17.0 inches
	private static final double TARGET_WIDTH_INCHES = 33.0; //set proper value PROPER VALUE IS 39.25 inches
	private static final double TARGET_ELEVATION_INCHES = 104-2.;

	private static final double CAM_ELEVATION_INCHES = 24.0; // set proper value 
