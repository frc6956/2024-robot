...
public class CANSparkMaxConstants {
    ...
    public final boolean analogEncoderRevert;

    public CANSparkMaxConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, double angleKF, boolean driveMotorInvert, boolean angleMotorInvert, boolean analogEncoderRevert){
        ...
        this.analogEncoderRevert = analogEncoderRevert;
    }

    /** Swerve Drive Specialties - MK4i Module*/
    public static CANSparkMaxConstants SDSMK4i(double driveGearRatio){
