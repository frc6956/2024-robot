...
public final class Translation2dPlus extends Translation2d {
  ...
  /**
   * The scalar projection of a vector u onto a vector v is the length of the "shadow" cast by u
   * onto v under a "light" that is placed on a line normal to v and containing the endpoint of u,
   * given that u and v share a starting point. spotless:off
	 * tl;dr:
	 *    _*
	 * u  /|
	 *   / |
  ...
  /**
   * The projection of a vector u onto a vector v is the vector in the direction of v with the
   * magnitude u.scal(v).
   *
  ...
  public boolean isWithinAngle(
      final Translation2d A, final Translation2d B, final Translation2d C, final boolean vertical) {
  ...
  public boolean isWithinAngle(
      final Translation2d A, final Translation2d B, final Translation2d C) {
    return isWithinAngle(A, B, C, false);
  }

  /** Assumes an angle centered at the origin. */
  public boolean isWithinAngle(
      final Translation2d A, final Translation2d C, final boolean vertical) {
